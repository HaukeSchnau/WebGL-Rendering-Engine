...
export default class Mesh {
  ...
  draw(shader: Shader) {
    ...
    gl.bindBuffer(gl.ARRAY_BUFFER, this.vbo);
    gl.vertexAttribPointer(shader.getAttribLocation("position"), 3, gl.FLOAT, false, Vertex.SIZE * 4, 0);
    gl.vertexAttribPointer(shader.getAttribLocation("texCoord"), 2, gl.FLOAT, false, Vertex.SIZE * 4, 3 * 4);
    gl.vertexAttribPointer(shader.getAttribLocation("normal"), 3, gl.FLOAT, false, Vertex.SIZE * 4, 5 * 4);
